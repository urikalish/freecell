...
export const THEMES: Theme[] = [
  {
    id: 'original',
    name: 'Original Brass',
    desc: 'Classic steampunk warmth',
    subtitle: 'Aetheric Card Engine',
    dots: ['#c9a84c', '#d4364f', '#2a9b6a'],
    vars: {
      '--brass': '#c9a84c',
      '--brass-light': '#e4c96a',
      '--brass-dark': '#8b6914',
      '--mahogany': '#2a1a0e',
      '--parchment': '#f0e6d0',
      '--parchment-dim': '#d4c8a8',
      '--ruby': '#a4243b',
      '--ruby-light': '#d4364f',
      '--emerald': '#1a6b4a',
      '--emerald-light': '#2a9b6a',
      '--ink-dark': '#1a1208',
      '--panel-bg': 'rgba(30,18,8,0.92)',
      '--card-bg': 'linear-gradient(145deg, #2a1e10, #1e1408)',
      '--card-border': 'rgba(139,105,20,0.2)',
      '--selected-bg': 'linear-gradient(145deg, #34240e, #2a1c0c)',
      '--bg-gradient':
        'linear-gradient(170deg, #1e1208 0%, #2a1a0e 30%, #1a1008 60%, #0e0a04 100%)',
      '--bg-accent1': 'rgba(184,115,51,0.08)',
      '--bg-accent2': 'rgba(201,168,76,0.06)',
      '--steam-color': 'rgba(200,190,170,0.06)',
      '--gear-opacity': '0.06',
      '--info-bg': 'rgba(14,10,4,0.94)',
      '--amber-glow': '0 0 12px rgba(201,168,76,0.3), 0 0 30px rgba(201,168,76,0.1)',
    },
  },
  {
    id: 'amber',
    name: 'Amber & Ivory',
    desc: 'Sunlit Victorian parlour',
    subtitle: 'Gilded Parlour Edition',
    dots: ['#d4b050', '#e04860', '#28b07a'],
    vars: {
      '--brass': '#d4b050',
      '--brass-light': '#f0d878',
      '--brass-dark': '#9a7a20',
      '--mahogany': '#2e1c10',
      '--parchment': '#f8f0dc',
      '--parchment-dim': '#e0d4b4',
      '--ruby': '#b8384a',
      '--ruby-light': '#e04860',
      '--emerald': '#1a7a58',
      '--emerald-light': '#28b07a',
      '--ink-dark': '#1e1408',
      '--panel-bg': 'rgba(34,22,10,0.90)',
      '--card-bg': 'linear-gradient(145deg, #302214, #24180c)',
      '--card-border': 'rgba(154,122,32,0.2)',
      '--selected-bg': 'linear-gradient(145deg, #3a2a14, #302214)',
      '--bg-gradient':
        'linear-gradient(170deg, #221608 0%, #302010 30%, #1e1408 60%, #100c04 100%)',
      '--bg-accent1': 'rgba(196,136,56,0.10)',
      '--bg-accent2': 'rgba(212,176,80,0.08)',
      '--steam-color': 'rgba(220,210,190,0.07)',
      '--gear-opacity': '0.07',
      '--info-bg': 'rgba(16,12,4,0.94)',
      '--amber-glow': '0 0 12px rgba(212,176,80,0.35), 0 0 30px rgba(212,176,80,0.12)',
    },
  },
  {
    id: 'midnight',
  ...
  },
  {
    ...
    subtitle: 'Oxidised Mechanism Edition',
  ...
  },
  {
    ...
    subtitle: 'Lunar Chronograph Edition',
  ...
  },
  {
    ...
    subtitle: 'First Exposure Edition',
