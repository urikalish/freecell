...
src/
  ...
  model/
    ...
    deck.ts             # MS FreeCell deal generator (deals 1-32000), state cloning
...
Deals are generated by `msFreeCellTableau` in `deck.ts` using the same linear congruential generator as the original Microsoft FreeCell (`seed = (seed * 214013 + 2531011) & 0x7fffffff`), producing the identical 32,000 classic deals.
